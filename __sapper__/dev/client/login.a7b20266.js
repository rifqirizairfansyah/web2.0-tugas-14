...
// (6:2) <FacebookLogin      clientId="757359035420206"      state="1"      redirectUri="http://localhost:3000/"      on:success={(params) => (user = params.detail.code)}      on:error={(error) => console.log(error)}      let:onLogin    >
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(6:2) <FacebookLogin      clientId=\\\"757359035420206\\\"      state=\\\"1\\\"      redirectUri=\\\"http://localhost:3000/\\\"      on:success={(params) => (user = params.detail.code)}      on:error={(error) => console.log(error)}      let:onLogin    >",
		ctx
	});
